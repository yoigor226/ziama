          ...
          <div className="flex justify-between h-16">
            ...
            <nav className="hidden md:flex space-x-8 items-center">
              ...
              <button
                ...
                className={`whitespace-nowrap cursor-pointer flex items-center px-3 py-2 text-sm font-medium ${activeTab === "classe" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-500 hover:text-indigo-500"}`}
              >
