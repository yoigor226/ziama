...
const ThirdBanner = () => {
  return (
    <div className="hidden md:block">
      <Card className="w-200 h-70 mt-8 ml-4 flex-row bg-blue-300">
          ...
          <CardBody>
            ...
            <Typography color="white" className="mb-8 font-normal">
              Gestion optimisée de vos ressources énergétiques avec des
              stratégies personnalisées pour réduire vos coûts.
            </Typography>
